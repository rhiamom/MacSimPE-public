...
/**
 * Tree node builder that organizes resources by type
 * Creates a simple hierarchy: All Resources -> Types (TXTR, MMAT, etc.)
 */
@interface ResourceTreeNodesByType : AResourceTreeNodeBuilder
