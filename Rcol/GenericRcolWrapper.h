 ...
 * @param refmap The Reference Map, Keys are the name of the Reference type, values are NSMutableArrays containing IPackedFileDescriptors
 */
- (void)findReferences:(NSMutableDictionary *)refmap;

/**
 * Add the References stored in the Reference Section
 * @param refmap The Reference Map, Keys are the name of the Reference type, values are NSMutableArrays containing IPackedFileDescriptors
 */
