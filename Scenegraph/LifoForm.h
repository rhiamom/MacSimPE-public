...
/**
 * UI Handler for LIFO (texture) files
 * Complete AppKit implementation of the LIFO Editor interface
 */
@interface LifoForm : NSViewController <IPackedFileUI>
...
/**
 * Initialize with associated wrapper
 * @param wrapper The LIFO wrapper this form edits
 */
