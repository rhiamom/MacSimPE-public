...
{
    // Uses your existing designated initializer
...
- (float)norm {
    float n = pow(self.x, 2) + pow(self.y, 2) + pow(self.z, 2);
    return n;
}
...
- (instancetype)init {
    return [self initWithX:0.0f y:0.0f z:0.0f];
}

- (instancetype)initWithX:(float)x y:(float)y {
    return [self initWithX:x y:y z:0.0f];   // ← override of superclass designated init
}

- (instancetype)initWithX:(float)x y:(float)y z:(float)z {
    self = [super initWithX:x y:y];         // ← call superclass designated init
    if (self) {
        self.z = z;
    }
    return self;
...
- (id)copyWithZone:(NSZone *)zone {
    return [[Vector3f allocWithZone:zone] initWithX:self.x y:self.y z:self.z];
}
    
- (instancetype)initWithStringArray:(NSArray<NSString *> *)dataArray {
    return [self initWithX:[dataArray[0] floatValue]
                         y:[dataArray[1] floatValue]
                         z:[dataArray[2] floatValue]];
}
...
- (instancetype)initWithNumberArray:(NSArray<NSNumber *> *)data {
    if (data.count >= 3) {
        return [self initWithX:[data[0] floatValue]
                             y:[data[1] floatValue]
                             z:[data[2] floatValue]];
    }
    return [self initWithX:0.0f y:0.0f z:0.0f];
